...
class NursesRegistrationViewModel with ChangeNotifier {
    ...
    if (formKey.currentState!.validate()) {
      ...
      if (code == 200) {
        SnackBarWidget.getSnackBar(
            context: context,
            showText: "Make Payment For Complete Registration");
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => OtherPaymentSectionScreen(
                selectedplan: "Nurse Registration",
                amount: "1",
